...
#    start_urls = my_parse.url_link
    ...
    def prase_info(self, response):
        ...
        for sel in response.xpath('//div[@class="zm-item-answer  zm-item-expanded"]'):
            ...
            print tmp_p
            tmp_p2 = sel.xpath('div/div[@class="zm-item-answer-author-info"]/span[@class="summary-wrapper"]/span/a/@href').extract()
            print tmp_p2
            if tmp_p :
                item['people'] = tmp_p[0]
            elif tmp_p2:
            ...
            # 赞大于zan_th的回答才是需要的
#            if int(zan_str.group(1)) >= ZhihuDetailSpider.my_parse.zan_th:
#                yield item

...
import MySQLdb
from zhihu_single.spiders.zhihu_single_spider import *
from zhihu_single.sqlToexcel import *

class ZhihuSinglePipeline(object):
    def __init__(self):
    ...
    def process_item(self,item,spider):
        ...
        self.qid_export.add(table_name)
    ...
    def close_spider(self, spider):
       sqlToexcel().start(self.qid_export)
       print 'close'

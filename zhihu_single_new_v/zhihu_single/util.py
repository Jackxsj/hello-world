...
class MyParse(object):
    ...
    def __init__(self):
        ...
        self.url_link = []
        tmp_url_link = "https://www.zhihu.com/question/"+str(self.queid)+"/answers/created"
        print tmp_url_link
        ...
        try:
            cur.execute('create database if not exists zhihu DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci')

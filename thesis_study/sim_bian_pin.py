...
N_val = []
P_val = []
get_sheet_with_name(u'bian_pin',N_val,P_val)
print N_val
print P_val
...
def fund(x, a, b):  
    return x*a+b
popt, pcov = curve_fit(fund, N_val, P_val)
P_est = [fund(i,popt[0],popt[1]) for i in N_val] 
print 'the value caculated 40 :'
print popt

plt.scatter(N_val,P_val,label=u'单价')
plt.plot(N_val,P_est,label=u'单价拟合曲线')

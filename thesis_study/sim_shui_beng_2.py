...
Q_title = [u'Q=6.2 拟合结果',u'Q=12.6 拟合结果',u'Q=50.4 拟合结果',u'Q=100 拟合结果',u'Q=150 拟合结果']
...
for ii in range(0,len(Q_tmp)):
    ...
    plt.plot(H_tmp[ii],y_est,'--',label=Q_title[ii])

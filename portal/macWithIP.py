...
def readFromMysql():
    ...
    cur = conn.cursor()
    cur.execute("select id,usermac from jf_old_user where id >10000 and id <20000")
    ...
    for i in cur:
        ...
        accounting_str = str(int(time.time()))+i[1]
        line2 = line+","+str(i[0])+","+challenge_str+","+accounting_str
        f2.write(line2)
        f2.write('\n')
